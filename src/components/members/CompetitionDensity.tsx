...
export default function CompetitionDensity({ data, years, year, onYearChange }: Props) {
  ...
  return (
    <div className="bg-white rounded-xl p-5" style={{ border: "1px solid var(--border)" }}>
      ...
      <p className="text-xs text-[#6b7280] mb-3">1案件あたりの平均参加業者数。多いほど競争が激しい</p>
          ...
          <BarChart data={sorted} layout="vertical" margin={{ top: 0, right: 50, left: 0, bottom: 0 }}>
            ...
            <Tooltip
              ...
              formatter={(v, _, { payload }) => [
                `平均 ${v}社 / 全${payload.total_cases}案件`, "競合密度",
              ]}
            />
